# Anonymised project brief

Build a reproducible DevOps lab around a small HTTP application. The lab must demonstrate:
...
The original assessment instructions, environment access details, and organisation-specific wording are intentionally not included because their publication rights and confidentiality could not be established from the archive.
